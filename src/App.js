      ...
      <div className='wrapper'>
        <Menu stackable>
          ...
          <Menu.Menu position='right'>
            ...
            <Menu.Item as='a' href="http://blog.geomatikuygulamalar.com/" target="_blank">Blog</Menu.Item>
          </Menu.Menu>
        </Menu>
        {this.props.children}
        <Divider />
        <Grid stackable>
          <Grid.Row>
            ...
            <Grid.Column width={6} textAlign="right">
              <a href="https://github.com/Geomates/geomatikuygulamalar/" target="_blank" rel="noopener noreferrer">Github</a>&nbsp;-&nbsp;
